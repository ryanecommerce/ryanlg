    ...
    <div>
        <div class="row justify-content-center">
            <form class="form-inline">
                ...
                <label for="name" class="sr-only">{{ item.status }}</label>
                <input @change="inputChanged()" type="text" class="form-control mb-2 mr-sm-2" id="status" v-model="item.status">

                <label for="year" class="sr-only">{{ item.year }}</label>
                <input @change="inputChanged()" type="text" class="form-control mb-2 mr-sm-2" id="year" v-model="item.year">
